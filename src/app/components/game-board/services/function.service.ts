...
export class FunctionService {
 ...
 public prepareBoard(cellX: number, cellY: number): boolean[][] {
  ...
  public drawBorders(ctx: any, cellX: number, cellY: number, size: number, width: number, height: number) {
    for( let i = 0; i < cellX ; i++ ) {
        ctx.beginPath();
  ...
  public drawAll(ctx: any, cellX: number, cellY: number, size: number, width: number, height: number, colors: string[], board: []) {
  ...
  public drawBoard(ctx: any, colors: string[], size: number , cellX: number, cellY: number, board: []) {
  ...
  setNewGeneration(cellX: number, cellY: number, board: []) {
